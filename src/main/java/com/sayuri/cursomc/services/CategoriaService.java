...
import com.sayuri.cursomc.dto.CategoriaDTO;
...
public class CategoriaService {
	...
	public Categoria update(Categoria obj) {
		Categoria newObj = find(obj.getId()); // Recupero os dados do banco para não sobreescrever os campos que não podem ser alterados
